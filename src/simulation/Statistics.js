...
/**
 * Generates statistics from the simulation log.
 */
export class Statistics {
  /**
   * Generates all statistics from the log.
   * @param {*[]} log simulation log
   * @param {BPMNDiagram} diagram diagram of process
   * @returns {*} statistics
   */
  ...
  /**
   * Creates summary statistics from the simulation log.
   * @param {*[]} log simulation log
   * @param {BPMNDiagram} diagram diagram of process
  ...
  /**
   * Creates instance-based statistics from the simulation log.
   * @param {*[]} log simulation log 
   * @param {BPMNDiagram} diagram diagram of process 
   * @returns {*} instances statistics
   */
  ...
  /**
   * Creates statistics based on activities from the simulation log.
   * @param {*[]} log simulation log  
   * @param {BPMNDiagram} diagram diagram of process
  ...
  /**
   * Counts work time for each resource type according to its work schedule.
   * @param {BPMNDiagram} diagram diagram of process 
   * @param {Timetable} timetable resource timetable
   * @param {*} general general statistics from log
   * @returns {number} work time of resource
   */
  static countWorktimeForResource(diagram,timetable,general) {
    let resultSecs = []
  ...
  /**
   * Creates resource utilization statistics based on the simulation log and general statistics.
   * @param {*[]} log simulation log 
   * @param {BPMNDiagram} diagram diagram of process 
   * @param {*} general general statistics from log
   * @returns {*} recource utilization statistics
   */
  static generateResourceUtilization(log, diagram, general) {
    ...
    for (const participant of participants) {
      let shiftLenght = this.countWorktimeForResource(diagram,diagram.getTimetableByName(participant.getWorkingHours()),general)
  ...
  /**
   * Helper function for czech unit formating
   * @param {*} count count
   * @param {*} forms text unit possibilities
   * @returns {*} czech text unit
   */
  ...
  /**
   * Prepares statistics time value for reading
   * @param {*} value value in seconds
   * @returns {string} readble value
   */
  ...
  /**
   * Converts system value from general statistics to czech readable text.
   * @param {*} value value to be converted
   * @returns {*} czech text value, if found
   */
  ...
  /**
   * Converts general values to readable text.
   * @param {*} description system description value
   * @param {*} value value
   * @param {BPMNDiagram} diagram diagram of process
  ...
  /**
   * Converts instances values to czech readable text.
   * @param {*} description system description value
   * @param {*} value value
   * @param {BPMNDiagram} diagram diagram of process
   * @returns {*} converted value
  ...
  /**
   * Generates warehouse costs for simulation run.
   * @param {BPMNDiagram} diagram diagram of process
   * @param {number} simulationDuration lenght of simulation
   * @returns {number|null} warehouse costs
   */

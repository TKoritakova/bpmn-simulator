  ...
  useEffect(() => {       
    ...
    return <div className="slide">
      ...
      <div className='slide-content-wrapper'>
        ...
        <p>Každá simulace potřebuje kromě modelu, který bude simulovat, i svá vstupní data, která ji ovlivňují. Těm se říká říká simulační scénář a ten může obsahovat tato data:</p>

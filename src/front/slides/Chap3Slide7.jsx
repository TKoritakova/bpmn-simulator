...
/**
 * React component displaying third lesson's seventh slide. 
 * @component
 * @param {*} param0 setSlideFinished
 * @param {*} param1 slideFinished
 * @returns {JSX.Element} React element displaying third lesson's seventh slide
 */
export default function Chap3Slide7({ setSlideFinished, slideFinished }) {
